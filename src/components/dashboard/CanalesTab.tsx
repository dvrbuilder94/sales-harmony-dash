...
import { MercadoLibreIntegration } from '@/components/MercadoLibreIntegration';
    ...
    <div className="space-y-8">
      <Tabs defaultValue="connections" className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="falabella">Falabella</TabsTrigger>
        ...
        <TabsContent value="connections" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Conexiones de Canales</CardTitle>
              <CardDescription>
                Gestiona las conexiones con diferentes marketplaces y plataformas de e-commerce
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChannelConnections />
        ...
        <TabsContent value="mercadolibre" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Integración MercadoLibre</CardTitle>
              <CardDescription>
                Conecta y sincroniza datos con MercadoLibre - Multi-canal
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="falabella" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Integración Falabella</CardTitle>
              <CardDescription>
                Conecta y sincroniza datos con Falabella
              </CardDescription>
            </CardHeader>
            <CardContent>
